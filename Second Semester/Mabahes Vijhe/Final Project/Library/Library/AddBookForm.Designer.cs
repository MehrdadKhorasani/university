    ...
    partial class AddBookForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            string[] labelTexts = new string[]
            {
                ...
                "کد استاندارد کتاب",
                "عنوان کتاب",
                "نام نویسنده", "نام خانوادگی نویسنده",
                "نام نویسنده دوم", "نام خانوادگی نویسنده دوم",
                "نام مترجم", "نام خانوادگی مترجم",
                "نام مترجم دوم", "نام خانوادگی مترجم دوم",
                "نام انتشارات",
                "سال انتشار",
                "قیمت روی جلد",
                "تعداد موجودی کل",
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                // تنظیم غیرقابل تغییر بودن تکست‌باکس شماره کتاب
                if (labelTexts[i] == "شماره کتاب (غیرقابل تغییر)")
                {
